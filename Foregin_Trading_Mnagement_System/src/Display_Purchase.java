...
public class Display_Purchase extends javax.swing.JFrame {
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        try {
            ...
            String[] billline = new String[100];
            String str;
            double price, total;
            ...
            for (int i = 0; itemline[i] != null; i++) {
                if (idx == i) {
                    ...
                    if ((qty <= qty_prv) && (qty_prv != 0)) {
                        ...
                        r++;
                        edited = true;
                        String ttl= new Double(total).toString();;
                        billline[i] = temp[0] + "\t\t" + qty + "\t" + ttl;
                        FileWriter myWriter = new FileWriter("bill.txt");
                        myWriter.write("ItemName\tQuantity\tPrice\n");
                        myWriter.write(billline[i]+"\n");
                        int total_price=0;
                        String st_price[]=billline[i].split("\t",4);
                        /*for(int k=0;itemline[k]!=null;k++){
                           total_price+=Integer.parseInt(st_price[2]); 
                           myWriter.write("\n"+total_price+"\n");
                    }*/
                        myWriter.close();
                    }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        try {
            ...
            double cash, change;
            do {
                cash = Double.parseDouble(JOptionPane.showInputDialog("Credit Card Payment:"));
                if (cash < total) {
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
      ...
      myWriter.write("Purchase Successful! We have mailed you the invoice.");
      myWriter.close();

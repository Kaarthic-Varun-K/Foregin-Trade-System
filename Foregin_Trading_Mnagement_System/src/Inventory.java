...
public class Inventory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Modern No. 20", 1, 50)); // NOI18N
        ...
        jLabel2.setText("Welcome to foreign trade system");
        jLabel2.setBorder(new javax.swing.border.MatteBorder(null));

        jLabel3.setFont(new java.awt.Font("Modern No. 20", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText("*Please click on search for searching the item required*");

        jLabel4.setFont(new java.awt.Font("Modern No. 20", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 51, 0));
        jLabel4.setText("*Please click on display for displaying all the items in the trading *");

        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\ACER.LAPTOP-0VMLKCCN\\Desktop\\12.PNG")); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       if(exit==0){
            JOptionPane.showMessageDialog(null, " Thank you for choosing foregin trade system,have agreat day ahead!!!");
        System.exit(0);
